...
class Link extends Component {
  ...
  _voteForLink = async () => {
    ...
    // update function will be called when the server returns the response; it receives the payload of the mutation (data) and the current cache (store) as arguments
